...
export default function Questions() {
	...
	return (
		<div>
			<h3 className="text-yellow-200 uppercase text-center my-3 text-sm">
				Questions and answers in category {category}
			</h3>
			<div className=" border-b border-blue-200 pb-3 flex flex-col">
				<div className="flex gap-3 justify-around my-3 sm:justify-center">
				<button className="text-red-200 border border-red-200 px-3 py-2 uppercase sm:w-36 text-sm"
					onClick={() => navigate(-1)}
				>
					Back
				</button>
				<button className=" text-green-200 border border-green-200 py-1 px-2 uppercase text-sm"
